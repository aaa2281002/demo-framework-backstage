 ...
 * @description 系统前端白名单IP实体类
 * @datetime 2019/10/11
 */
@ApiModel(value = "系统前端白名单IP", description = "系统前端白名单IP", parent = BaseModel.class)
public class SystemFrontWhiteListIp extends BaseModel implements Serializable {
