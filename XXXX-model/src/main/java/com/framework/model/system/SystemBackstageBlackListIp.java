 ...
 * @datetime 2019/10/11
 */
@ApiModel(value = "系统后台黑名单IP", description = "系统后台黑名单IP", parent = BaseModel.class)
public class SystemBackstageBlackListIp extends BaseModel implements Serializable {
    private static final long serialVersionUID = -1L;
    //是否启用=1启用,2禁用
    @ApiModelProperty(value = "否启用=1启用,2禁用", name = "isEnable", dataType = "Integer", required = true, allowableValues = "1", hidden = false, position = 100)
    ...
    //IP
    @ApiModelProperty(value = "IP", name = "ip", dataType = "String", required = true, allowableValues = "15", hidden = false, position = 101)
    ...
    private String ip;
    //描述
    @ApiModelProperty(value = "描述", name = "description", dataType = "String", required = false, allowableValues = "1000", hidden = false, position = 102)
