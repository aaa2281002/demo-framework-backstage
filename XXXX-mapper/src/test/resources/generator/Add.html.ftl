...
<div class="layuimini-container">
    <div class="layuimini-main">
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>${fullName}新增</legend>
        </fieldset>
        <form class="layui-form" id="${className}FormAdd" action="">
            <#list addList as field>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block" <#if isText>style="border: 1px solid #ccc;"</#if>>
                    ...
                    <input th:each="item : ${currencySymbol}{@systemTypeServiceImpl.findByCodeList('isEnable')}"
                           ...
                           th:checked="${currencySymbol}{1 == item.typeValue}"
                    ...
                    <textarea style="display: none;" name="${field.code}" id="${field.code}"></textarea>
                        <#else>
            ...
            <div class="layui-form-item"
                ...
                <div class="layui-input-block">
                    <a class="layui-btn" lay-submit="" lay-filter="${className}FormAddSubmit">保存</a>
                </div>
            </div>
        </form>
    </div>
...
<script th:inline="javascript">
    ...
    layui.use(['form'<#if isBigDecimal || isText>, 'common'</#if><#if isText>, 'wangEditor'</#if>], function () {
        ...
        //监听提交
        form.on('submit(${className}FormAddSubmit)', function (data) {
            $.ajax({
                type: 'POST',
                url: '${url}/save',
                data: data.field,
