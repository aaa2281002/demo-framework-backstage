...
public class RedisPrefixUtil {
    ...
    public static final String REDIS_KEY_LOGON_KEY = "logon"; //登录组装前缀
    ...
    public static final String PREFIX_STR_PERMISSION_ROLE_URL = "PERMISSION_ROLE_URL";//redis权限角色URL缓存前缀

    public static final String PREFIX_STR_LOGIN_SYSTEM_USER = "LOGIN_SYSTEM_USER";//redis用户登录成功缓存前缀
    public static final String PREFIX_STR_LOGIN_SYSTEM_USER_TOKEN = "LOGIN_SYSTEM_USER_TOKEN";//redis用户登录Token成功缓存前缀
    ...
    public static final String PREFIX_STR_SERVICES_ORDER_TIME = "SERVICES_ORDER_TIME";//redis服务订单键缓存前缀
    public static final String PREFIX_STR_QUERY_SERVICES_ORDER_TIME = "QUERY_SERVICES_ORDER_TIME";//redis查询服务订单键缓存前缀
    public static final String PREFIX_STR_VIP_ORDER_TIME = "VIP_ORDER_TIME";//redisVIP订单键缓存前缀
}
