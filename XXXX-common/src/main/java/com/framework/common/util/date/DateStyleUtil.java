...
public class DateStyleUtil {
    ...
    public static final String FORMAT_YYYYMMDD_HHMMSS_COLON = FORMAT_YYYYMMDD + " " + FORMAT_HHMMSS_COLON;
    ...
    public static final String STRING_CHINA_TIMEZONE = "GMT+8";
    public static final String STRING_EEE_MMM_DD_HH_MM_SS_ZZZ_YYYY = "EEE MMM dd HH:mm:ss zzz yyyy";
}
