...
public class InitMenuUtil {
    ...
    //Logo请求URL
    public final static String VALUE_MENU_LOGO_URL_PATH = "/index";
    ...
    //map子项键
    public final static String KEY_MENU_NAME = "menuName";//菜单键
    public final static String KEY_MENU_ICON = "icon";//图标键
    public final static String KEY_MENU_URL_PATH = "urlPath";//请求路径键
    public final static String KEY_MENU_IMAGE = "image";//图片键
    public final static String KEY_MENU_CLEAR_URL = "clearUrl";//清除键
