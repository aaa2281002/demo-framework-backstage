 ...
 * @datetime 2019/10/11
 */
@Api(tags = "系统后台白名单IP", description = "系统综合管理")
@Validated
@Controller
...
public class SystemBackstageWhiteListIpController extends BaseController {
    ...
    public ResponseResult getByIdInfo(@NotNull(message = "请选择后台白名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "后台白名单不存在") Long id) {
        return systemBackstageWhiteListIpServiceImpl.getByIdInfo(id);
    }
    ...
    public ResponseResult save(@RequestBody @Validated(value = {ValidationGroup.formAdd.class}) SystemBackstageWhiteListIp param) {
    ...
    public ResponseResult edit(@RequestBody @Validated(value = {ValidationGroup.formEdit.class}) SystemBackstageWhiteListIp param) {
    ...
    public ResponseResult batchDel(@NotEmpty(message = "请选择后台白名单")
                                   @Size(min = NumeralUtil.POSITIVE_ONE, message = "后台白名单不存在")
    ...
    public ResponseResult del(@NotNull(message = "请选择后台白名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "后台白名单不存在")
