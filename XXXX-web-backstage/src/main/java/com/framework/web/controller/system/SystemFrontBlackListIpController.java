 ...
 * @datetime 2019/10/11
 */
@Api(tags = "系统前端黑名单IP", description = "系统综合管理")
@Validated
@Controller
...
public class SystemFrontBlackListIpController extends BaseController {
    ...
    public ResponseResult getByIdInfo(@NotNull(message = "请选择前端黑名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "前端黑名单不存在") Long id) {
        return systemFrontBlackListIpServiceImpl.getByIdInfo(id);
    }
    ...
    public ResponseResult findPageList(@Validated(value = {ValidationGroup.formPageQuery.class}) SystemFrontBlackListIp param,
    ...
    public ResponseResult save(@RequestBody @Validated(value = {ValidationGroup.formAdd.class}) SystemFrontBlackListIp param) {
    ...
    public ResponseResult edit(@RequestBody @Validated(value = {ValidationGroup.formEdit.class}) SystemFrontBlackListIp param) {
    ...
    public ResponseResult del(@NotNull(message = "请选择前端黑名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "前端黑名单不存在")
