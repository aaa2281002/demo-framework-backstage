 ...
 * @datetime 2019/10/11
 */
@Api(tags = "系统前端白名单IP", description = "系统综合管理")
@Validated
@Controller
...
public class SystemFrontWhiteListIpController extends BaseController {
    ...
    public ResponseResult getByIdInfo(@NotNull(message = "请选择前端白名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "前端白名单不存在") Long id) {
        return systemFrontWhiteListIpServiceImpl.getByIdInfo(id);
    }
    ...
    public ResponseResult save(@RequestBody @Validated(value = {ValidationGroup.formAdd.class}) SystemFrontWhiteListIp param) {
    ...
    public ResponseResult edit(@RequestBody @Validated(value = {ValidationGroup.formEdit.class}) SystemFrontWhiteListIp param) {
    ...
    public ResponseResult del(@NotNull(message = "请选择前端白名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "前端白名单不存在")
