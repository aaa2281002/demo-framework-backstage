 ...
 * @datetime 2019/10/11
 */
@Api(tags = "系统后台黑名单IP", description = "系统综合管理")
@Validated
@Controller
...
public class SystemBackstageBlackListIpController extends BaseController {
    ...
    public ResponseResult getByIdInfo(@NotNull(message = "请选择后台黑名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "后台黑名单不存在") Long id) {
        return systemBackstageBlackListIpServiceImpl.getByIdInfo(id);
    }
    ...
    public ResponseResult save(@RequestBody @Validated(value = {ValidationGroup.formAdd.class}) SystemBackstageBlackListIp param) {
    ...
    public ResponseResult edit(@RequestBody @Validated(value = {ValidationGroup.formEdit.class}) SystemBackstageBlackListIp param) {
    ...
    public ResponseResult batchDel(@NotEmpty(message = "请选择后台黑名单")
                                   @Size(min = NumeralUtil.POSITIVE_ONE, message = "后台黑名单不存在")
    ...
    public ResponseResult del(@NotNull(message = "请选择后台黑名单") @Min(value = NumeralUtil.POSITIVE_ONE, message = "后台黑名单不存在")
