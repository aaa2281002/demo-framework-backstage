...
//    @Autowired
    ...
    public MySecurityMetadataSource(PathMatcher pathMatcher, IgnoredUrlsProperties ignoredUrlsProperties, IgnoredRoleAuth ignoredRoleAuth) {
        this.pathMatcher = pathMatcher;
        this.ignoredUrlsProperties = ignoredUrlsProperties;
        this.ignoredRoleAuth = ignoredRoleAuth;
    }
