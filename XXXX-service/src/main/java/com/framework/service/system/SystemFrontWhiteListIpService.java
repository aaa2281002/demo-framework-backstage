 ...
 * @description 系统前端白名单IP业务接口类
 * @date 2021/12/12 17:35
 */
public interface SystemFrontWhiteListIpService {
    /**
     ...
     */
    ResponseResult save(SystemFrontWhiteListIp row);
     ...
     * @datetime 2019/12/26 11:13
     */
    ResponseResult edit(SystemFrontWhiteListIp row);
     ...
     */
    SystemFrontWhiteListIp getByIdParam(Long id);
     ...
     */
    ResponseResult findParamPageList(SystemFrontWhiteListIp param);
     ...
     */
    SystemFrontWhiteListIp getIp(String ip);
}
