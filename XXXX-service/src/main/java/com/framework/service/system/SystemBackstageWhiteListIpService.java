...
public interface SystemBackstageWhiteListIpService {
     ...
     */
    ResponseResult save(SystemBackstageWhiteListIp row);
     ...
     * @datetime 2019/12/26 11:13
     */
    ResponseResult edit(SystemBackstageWhiteListIp row);
     ...
     */
    ResponseResult findParamPageList(SystemBackstageWhiteListIp param);
